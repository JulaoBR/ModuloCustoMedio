...
namespace ProEstoque.CONTROL
{
    public class ControlEmail
    {
        ...
        private static string emailDestino = "julio@massaslott.com.br, julioscp2009@hotmail.com";
        private static string assunto = "ALERTA DE PRODUTO ABAIXO DO ESTOQUE MINIMO";
        ...
        public static void EnviaEmail(ModelRegistro registro)
        {
            //CLIENTE
